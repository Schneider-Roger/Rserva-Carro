...
import { Bell, CalendarDays, CarFront, Home, LayoutDashboard, Menu, PlusCircle, ShieldCheck, X } from 'lucide-react';
    ...
    <div className="app-shell">
      ...
      <aside className={`sidebar ${open ? 'is-open' : ''}`}>
        <div className="brand-row">
          ...
          <div><strong>Frota Leve</strong><span>Copercana</span></div>
        ...
        <div className="sidebar-footer">Versão 0.1 · UX Preview</div>
      </aside>
      ...
      <div className="app-column">
        <header className="topbar">
          ...
          <div className="user-chip">
            ...
            <div><strong>{currentUser.name}</strong><span>{currentUser.unit}</span></div>
          </div>
        </header>
